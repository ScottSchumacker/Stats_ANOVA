...
We can see that there is a statistically significant difference between Drug B and Drug A and there is a statistically significant difference between Drug C and Drug A and not significant difference between Drug B and Drug C. This points us to the conclusion that Drug A is may be more optimal for lowering blood pressure.